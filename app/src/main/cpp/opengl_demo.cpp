...
Java_com_ricardo_openglel_1study_DemoActivity_createBitmapRender(JNIEnv *env, jobject thiz,
                                                              jobject bitmap) {
...
Java_com_ricardo_openglel_1study_DemoActivity_drawBitmap(JNIEnv *env, jobject thiz, jlong drawer) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_ricardo_openglel_1study_DemoActivity_releaseNative(JNIEnv *env, jobject thiz, jlong render) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_ricardo_openglel_1study_DemoActivity_onOutputSizeChanged(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_ricardo_openglel_1study_DemoActivity_setFilterNative(JNIEnv *env, jobject thiz, jlong render,
                                                           jlong filter) {
    ImageRender *pImageRender = reinterpret_cast<ImageRender *>(render);
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_ricardo_openglel_1study_DemoActivity_createFilterByTypeNative(JNIEnv *env, jobject thiz,
                                                                    jint filter_type) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_ricardo_openglel_1study_DemoActivity_adjustFilterProgressNative(JNIEnv *env, jobject thiz,
                                                                      jint filter_type,
...
Java_com_ricardo_learn_1camerax_MainActivity_switchToFilterNative(JNIEnv *env, jobject thiz,
    ...
    if (pRender != NULL) {
        pRender->setFilter(
                reinterpret_cast<ImageFilter *>(Java_com_ricardo_openglel_1study_DemoActivity_createFilterByTypeNative(
...
Java_com_ricardo_learn_1camerax_MainActivity_adjust(JNIEnv *env, jobject thiz, jint render,
    ...
    if (pRender != NULL) {
        ...
        Java_com_ricardo_openglel_1study_DemoActivity_adjustFilterProgressNative(env, thiz,
                                                                              filter_type,
                                                                              pFilter, value);
    }
